...
import com.example.kaili.tree_recycleview.R;
import com.example.kaili.tree_recycleview.TreeData;
...
public class TreeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((CheckBox) holder.itemView.findViewById(R.id.cb_checked)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (!displayNodes.get(holder.getLayoutPosition()).isLeaf()) {//是父元素时
                    if (onTreeNodeListener != null) {
                        onTreeNodeListener.onCheckedChanged(data.getChecked());
